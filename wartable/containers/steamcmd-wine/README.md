...
The [GitHub](https://github.com/the-peon-project/peon/tree/main/wartable/containers/steamcmd-wine) repo for developing the container.
...
1. Download the following files from the PEON recipes [GitHub location](https://github.com/the-peon-project/peon/tree/main/warplans/vrising)
    - .env.example
    - docker-compose.yml
    - server_start
